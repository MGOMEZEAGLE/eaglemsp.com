...
const SUB_HREF = {
  'Managed IT Support': 'ManagedITSupport.html',
  'Cybersecurity': 'ManagedITSupport.html',
  'Strategic IT': 'ManagedITSupport.html',
  'Co-Managed IT': 'CoManagedIT.html',
  'Remote-Only IT': 'RemoteOnlyIT.html',
  'Hardware & Physical Security': 'ManagedITSupport.html',
...
const TOP_HREF = {
  'Solutions': 'ManagedITSupport.html',
    ...
    return (
      <section className="hero hero-centered" data-screen-label="Hero">
        ...
        <div className="container hero-c-inner">
          ...
          <p className="hero-sub">Proactive cybersecurity, fast local support, and a team watching your network around the clock. Built for businesses, municipalities, and non-profits of roughly 10 to 150 employees across New Hampshire and Maine.</p>
...
function TrustRibbon() {
  const stats = [
    ...
    { ico: 'pin', num: '0', lbl: 'Outside investors, ever' },
