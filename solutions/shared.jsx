...
function ImagePlaceholder({ label, icon = "image", className = "", src }) {
  if (src) {
    return (
      <figure className={`imgph has-photo ${className}`}>
        <img src={src} alt={label} loading="lazy" />
      </figure>
    );
  }
  return (
    <figure className={`imgph illus ${className}`} role="img" aria-label={label}>
      <span className="illus-art">
        <span className="illus-ring r1" />
        <span className="illus-ring r2" />
        <span className="illus-ring r3" />
        <span className="illus-ico"><Ic name={icon} /></span>
      </span>
      <figcaption className="illus-cap">{label}</figcaption>
    </figure>
  );
}
