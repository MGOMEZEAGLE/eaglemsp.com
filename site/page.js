...
(function () {
  ...
  function schedule(s) {
    var url = s.url || window.EAGLE_TIMEZEST_URL || "https://eaglemsp.timezest.com/";
    var needsUrl = !s.url && !window.EAGLE_TIMEZEST_URL;
    return '<section class="section"><div class="container">' + (s.title ? secHead(s, true) : '') +
      '<div class="schedule-embed reveal" style="max-width:840px;margin:0 auto">' +
        ...
        (needsUrl ? '<p class="tz-note"><span class="launch-flag">Booking URL needed</span><br>Live TimeZest embed is wired and rendering. Set <code>window.EAGLE_TIMEZEST_URL</code> to Eagle\u2019s real booking link to go live.</p>'
                  : '<p class="tz-note">Powered by TimeZest. Times shown are Eastern.</p>') +
      '</div></div></section>';
  }
