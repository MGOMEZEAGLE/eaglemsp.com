    ...
    document.getElementById("pc-root").innerHTML =
      ...
      '<section class="pc-sec" style="padding-top:0"><div class="container"><div class="pc-grid">' +
        ...
        '<aside><div class="summary">' +
          ...
          '</div>' +
          '<p class="summary-note"><b>Quoted separately based on your specific needs:</b> SIEM services, Compliance Monitoring, Backups (server and workstation), Secure AI. Microsoft 365 licensing is passed through at MSRP with no markup if we manage your tenant.</p>' +
