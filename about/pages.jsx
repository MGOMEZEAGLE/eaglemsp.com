...
function WhoWeArePage() {
  ...
  const why = [
    ...
    { icon: "heart", title: "Founder-led, team-driven", body: "Eagle stays independent and locally owned, with no outside capital and no roll-up. Our leadership team and engineers are invested in the relationships that make Eagle what it is." },
  ];
  const values = [
  ...
  return (
    <>
      ...
      <window.Callout
        solo
        eyebrow="Independent by choice"
        title="Founder-led. No outside capital. Not part of a roll-up."
        body="Plenty of the IT companies serving New England have been bought by private equity or folded into a national roll-up. We have not, and we are not planning to. Eagle is family-owned, founder-led, and answerable to our clients and our team rather than to investors looking for a return. It is the reason we can right-size a plan instead of upselling one, and the reason the person who answers your call still works here next year."
      />
      <window.FeatureSplit
        eyebrow="Our story"
        title="Built from the ground up. Still growing."
        paras={[
          "Eagle was founded in 1999 on a simple commitment: give New England businesses access to enterprise-grade IT support. That commitment has grown into a trusted regional MSP with two offices, a dedicated team of engineers and specialists, and a client satisfaction score that speaks for itself.",
          "We're family-owned and independently operated, which means the people making decisions about your IT are the same people who answer when something goes wrong. No layers. No runaround. Just a team that genuinely cares about your business.",
        ]}
        badge={{ icon: "award", text: "Independently owned since 1999" }}
        mediaLabel="The Eagle team at work"
        mediaIcon="users"
        reverse
      />
      <window.FeatureSplit
        eyebrow="Leadership"
        title="A deep bench, not a single name."
        paras={[
          "Eagle is run by a next-generation leadership team that owns day-to-day operations, service delivery, and client relationships. Founder Kaleb Jacob remains involved in vision and long-standing client relationships, but the company no longer runs through any one person.",
          "That is the point. It means the promises we make to you are kept by a full team of engineers and specialists, every day and every night, not by whoever happens to be available.",
        ]}
        badge={{ icon: "users", text: "Organizational depth, not a single point of failure" }}
        mediaLabel="The Eagle leadership team"
        mediaIcon="users"
      />
...
function TeamPage() {
  const members = [
    ...
    { name: "Michele", dept: "Operations & Business Development", role: "Operations Assistant", placeholder: true, bio: "Bio coming soon." },
    // Engineering
    { name: "James", dept: "Engineering", role: "Systems Engineer", placeholder: true, bio: "Bio coming soon." },
    { name: "Jacob", dept: "Engineering", role: "Systems Engineer", placeholder: true, bio: "Bio coming soon." },
    { name: "Mark", dept: "Engineering", role: "Systems Engineer", placeholder: true, bio: "Bio coming soon." },
    // Service Delivery & Field Services
    { name: "Luke", dept: "Service Delivery & Field Services", role: "Manager, Help Desk / Field Services", placeholder: true, bio: "Bio coming soon." },
    { name: "Raegan", dept: "Service Delivery & Field Services", role: "Help Desk Manager / Project Manager", placeholder: true, bio: "Bio coming soon." },
    { name: "Josh", dept: "Service Delivery & Field Services", role: "Service Technician II", placeholder: true, bio: "Bio coming soon." },
    { name: "Philip", dept: "Service Delivery & Field Services", role: "Service Technician I", placeholder: true, bio: "Bio coming soon." },
    { name: "David", dept: "Service Delivery & Field Services", role: "Service Technician I", placeholder: true, bio: "Bio coming soon." },
    { name: "Patrick", dept: "Service Delivery & Field Services", role: "Service Technician I", placeholder: true, bio: "Bio coming soon." },
    { name: "Dylan", dept: "Service Delivery & Field Services", role: "Service Technician I", placeholder: true, bio: "Bio coming soon." },
    { name: "Zach", dept: "Service Delivery & Field Services", role: "Service Technician I", placeholder: true, bio: "Bio coming soon." },
    { name: "Grant", dept: "Service Delivery & Field Services", role: "Dispatcher", placeholder: true, bio: "Bio coming soon." },
  ];
  return (
    <>
      <window.Hero
